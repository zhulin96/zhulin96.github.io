<?php
       ...
       ini_set('memory_limit', '2000M'); //内存限制 
       set_time_limit(0); //
...
$arr_ark=json_encode($ark);
  ...
  file_put_contents("../process/file/trans100.txt",$zp1);	
  file_put_contents("../process/file/trans1.txt",$zp2);
  file_put_contents("../process/file/trans2.txt",$zp3);
  file_put_contents("../process/file/trans3.txt",$zp4);
  file_put_contents("../process/file/trans4.txt",$zp5);
